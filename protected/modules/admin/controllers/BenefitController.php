...
class BenefitController extends AdminController
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Benefit'];
			if($model->save()) {
                Yii::app()->user->setFlash('success', "Блок был успешно сохранен.");
	...
	{
		$dataProvider=new CActiveDataProvider('Benefit');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='benefit-form')
		{
